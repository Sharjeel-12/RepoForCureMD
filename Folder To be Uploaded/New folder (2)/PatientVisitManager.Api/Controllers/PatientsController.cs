...
public class PatientsController : ControllerBase
{
    ...
    {
        var id = await _repo.CreateAsync(new Patient { PatientName = dto.PatientName, PatientEmail = dto.PatientEmail, PatientPhone = dto.PatientPhone, PatientDescription = dto.PatientDescription, VisitID = dto.VisitID });
