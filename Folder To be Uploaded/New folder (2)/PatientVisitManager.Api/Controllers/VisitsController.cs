...
public class VisitsController : ControllerBase
{
    ...
    public async Task<ActionResult> Create([FromBody] CreateVisitDto dto)
    {
        ...
        var id = await _repo.CreateAsync(new Visit { VisitType = dto.VisitType, VisitTypeID = dto.VisitTypeID, VisitDuration = dto.VisitDuration, VisitDate = dto.VisitDate, VisitFee = fee });
