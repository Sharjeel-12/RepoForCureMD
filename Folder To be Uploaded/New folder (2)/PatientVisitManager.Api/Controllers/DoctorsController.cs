...
public class DoctorsController : ControllerBase
{
    ...
    {
        var id = await _repo.CreateAsync(new Doctor { DoctorName = dto.DoctorName, DoctorEmail = dto.DoctorEmail, DoctorPhone = dto.DoctorPhone, Specialization = dto.Specialization, VisitID = dto.VisitID });
